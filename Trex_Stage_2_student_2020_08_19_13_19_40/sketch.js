...
var ground, invisibleGround, cloudImage, groundImg, cloudsGroup;
...
function draw() {
  ...
  if(obstaclesGroup.isToching(trex)) {
    gameState = END;
  }
}
...
function reset() {
  ...
  if(localStorage["HigheScore"]<score) {
    localStorage["HigheScore"] = score;

  }
  console.log(localStorage["HigheScore"]);
